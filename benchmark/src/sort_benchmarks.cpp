...
static void sorted_arr_stable_sort_std(benchmark::State& state) {
    for (auto _ : state) {
        sorted_arr_sort_benchmark()(std::stable_sort);
    }
}

static void sorted_arr_stable_sort_eastl(benchmark::State& state) {
    for (auto _ : state) {
        sorted_arr_sort_benchmark()(eastl::stable_sort);
    }
}

static void sorted_arr_stable_sort_ciel(benchmark::State& state) {
    for (auto _ : state) {
