...
TEST(deque_tests, insert_and_erase) {
    ...
    ASSERT_EQ(v3,
              ciel::deque({8, 4, 222, 222, 222, 3, 2, 1, 2, 3, 4, 8, 543, 12, 9, 8, 4, 222, 222, 222, 3, 2, 1, 2, 3, 4,
                           8, 543, 12, 9}));

    v3.insert(v3.end() - 2, 4, 9876);
    ASSERT_EQ(v3,
              ciel::deque({8, 4, 222, 222, 222, 3, 2, 1, 2, 3, 4, 8, 543, 12, 9, 8, 4, 222, 222, 222, 3, 2, 1, 2, 3, 4,
                           8, 543, 9876, 9876, 9876, 9876, 12, 9}));

    v3.insert(v3.begin() + 3, 6, 7890);
    ASSERT_EQ(v3,
              ciel::deque({8, 4, 222, 7890, 7890, 7890, 7890, 7890, 7890, 222, 222, 3, 2, 1, 2, 3, 4, 8, 543, 12, 9, 8,
                           4, 222, 222, 222, 3, 2, 1, 2, 3, 4, 8, 543, 9876, 9876, 9876, 9876, 12, 9}));
